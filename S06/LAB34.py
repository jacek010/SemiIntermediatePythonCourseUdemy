...
def exports_all_cakes_to_html(cls, path):
    template_header = """
            <table border=1>"""
    template_data = """
     <tr>
...
Cake.export_1_cake_to_html(cake01,'LAB34_files/cake01.html')

# Class method
Cake.export_all_cakes_to_html = types.MethodType(exports_all_cakes_to_html, Cake)
Cake.export_all_cakes_to_html('LAB34_files/cakes.html')

# Instance method
for cake in Cake.bakery_offer:
    cake.export_this_cake_to_html = types.MethodType(export_this_cake_to_html, cake)
for cake in Cake.bakery_offer:
    cake.export_this_cake_to_html(f'LAB34_files/{cake.name}.html')
