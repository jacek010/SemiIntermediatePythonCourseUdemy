class Cake:
    ...
    bakery_offer = []
    def __init__(self, name: str, taste: str, additives: list, filling: str, gluten_free: bool):
...
cake_01 = Cake('Tiramisu', 'coffe', ['coffe', 'chocolate sirup'], '', True)
cake_02 = Cake('Apple Pie', 'fruit', ['apples'], 'apples', False)
